...
export default function ButtonComponent(props : any){
  ...
  return (
    <div className="button-container">
      <button className={`button ${props.DisplayDms ? 'focused' : ''}`} onClick={props.HandleDisplayDms}>Inbox </button>
      <button className={`button ${props.DisplayRoom ? 'focused' : ''}`} onClick={props.HandleDisplayRoom}>Communities</button>
