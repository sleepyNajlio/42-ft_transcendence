...
-- CreateEnum
CREATE TYPE "ChatType" AS ENUM ('GLOBAL', 'PRIVATE');
...
-- CreateEnum
CREATE TYPE "RelationStatus" AS ENUM ('PENDING', 'ACCEPTED', 'DECLINED');
...
CREATE TABLE "ChatMessage" (
    "id_chat_message" SERIAL NOT NULL,
    "message" TEXT NOT NULL,
    "userId" INTEGER NOT NULL,
    "chatId" INTEGER NOT NULL,
    "sentAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ChatMessage_pkey" PRIMARY KEY ("id_chat_message")
);
